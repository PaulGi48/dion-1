! function(e) {
    ...
    jQuery(document).ready((function(e) {
        e("nav>ul>li>a.internal_link").on("click", (function(t) {
            t.preventDefault();
            var n = e(this).attr("href");
            e("nav>ul>li>a").removeClass("active"), e(this).addClass("active"), e("section:visible").fadeOut(400, (function() {
                e(n).fadeIn(400)
            }))
        })), e("input[type=email]").focus((function() {
            ...
            var n = e(this).attr("action"),
                i = e(this).serialize(),
                o = e(this).find(".btn-submit").html(),
                r = e(this).find(".btn-submit").attr("data-load");
            e(this).find(".btn-submit").text(r), e.post(n, i, (function(t, n, i) {
                switch (console.log(t), i.status) {
                    case 200:
                        e("form").find(".btn-submit").html(o), e(".Form-Wrapper").hide(), e(".thankyou-mailinglist").show();
                        break;
                    case 400:
                    case 404:
                    case 410:
                ...
                e("form").find(".btn-submit").html(o), alert("Something went wrong! Please try again.")
            }))
            ...
            closeBtnInside: !1
        }), e(".tour-btn").on("click", (function(t) {
            t.preventDefault(), e.magnificPopup.close(), e("nav>ul>li:nth-child(3)>a").trigger("click")
        }))
    }))
}, function(e, t, n) {
    (function(i) {
        ...
        r = [n(0)], void 0 === (a = "function" == typeof(o = function(e) {
            var t, n, o, r, a, s, l = function() {},
                c = !!i,
                u = e(window),
                p = function(e, n) {
                    t.ev.on("mfp" + e + ".mfp", n)
            ...
            l.prototype = {
                ...
                open: function(n) {
                    ...
                    if (!t.isOpen) {
                        ...
                        f("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (p("MarkupParse", (function(e, t, n, i) {
                            n.close_replaceWith = m(i.type)
                        })), a += " mfp-close-btn-in") : t.wrap.append(m())), t.st.alignTop && (a += " mfp-align-top"), t.fixedContentPos ? t.wrap.css({
                        ...
                        return t.isIE7 && (y += " mfp-ie7"), y && t._addClassToMFP(y), t.updateItemHTML(), f("BuildControls"), e("html").css(h), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || e(document.body)), t._lastFocusedEl = document.activeElement, setTimeout((function() {
                            t.content ? (t._addClassToMFP("mfp-ready"), t._setFocus()) : t.bgOverlay.addClass("mfp-ready"), o.on("focusin.mfp", t._onFocusIn)
                        }), 16), t.isOpen = !0, t.updateSize(g), f("Open"), n
                    }
                    t.updateItemHTML()
                },
                close: function() {
                ...
                updateItemHTML: function() {
                    ...
                    t.appendContent(a, i), n.preloaded = !0, f("Change", n), r = n.type, t.container.prepend(t.contentContainer), f("AfterChange")
                },
                appendContent: function(e, n) {
                    t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[n] ? t.content.find(".mfp-close").length || t.content.append(m()) : t.content = e : t.content = "", f("BeforeAppend"), t.container.addClass("mfp-" + n + "-holder"), t.contentContainer.append(t.content)
                },
                parseEl: function(n) {
                    var i, o = t.items[n];
                    if (o.tagName ? o = {
                ...
                updateStatus: function(e, i) {
                    if (t.preloader) {
                        ...
                        f("UpdateStatus", o), e = o.status, i = o.text, t.preloader.html(i), t.preloader.find("a").on("click", (function(e) {
                ...
                _parseMarkup: function(t, n, i) {
                    var o;
                    i.data && (n = e.extend(i.data, n)), f("MarkupParse", [t, n, i]), e.each(n, (function(n, i) {
                ...
                if ("string" == typeof n)
                    if ("open" === n) {
                        var o, r = c ? i.data("magnificPopup") : i[0].magnificPopup,
                    ...
                    getInline: function(n, i) {
                        if (C(), n.src) {
                            ...
                            if (r.length) {
                                ...
                                a && a.tagName && (v || (h = o.hiddenClass, v = d(h), h = "mfp-" + h), y = r.after(v).detach().removeClass(h)), t.updateStatus("ready")
            ...
            e.magnificPopup.registerModule("ajax", {
                ...
                proto: {
                    initAjax: function() {
                        t.types.push("ajax"), b = t.st.ajax.cursor, p("Close.ajax", x), p("BeforeChange.ajax", x)
                    },
                    getAjax: function(n) {
            ...
            e.magnificPopup.registerModule("image", {
                ...
                proto: {
                    initImage: function() {
                        var n = t.st.image,
                            i = ".image";
                        t.types.push("image"), p("Open" + i, (function() {
                            "image" === t.currItem.type && n.cursor && e(document.body).addClass(n.cursor)
                        })), p("Close" + i, (function() {
                            n.cursor && e(document.body).removeClass(n.cursor), u.off("resize.mfp")
                        })), p("Resize" + i, t.resizeImage), t.isLowIE && p("AfterChange", t.resizeImage)
                    },
                    ...
                    _onImageHasSize: function(e) {
                        e.img && (e.hasSize = !0, I && clearInterval(I), e.isCheckingImgSize = !1, f("ImageHasSize", e), e.imgHidden && (t.content && t.content.removeClass("mfp-loading"), e.imgHidden = !1))
                    },
                        ...
                        var n = 0,
                            ...
                            o = function(r) {
                                I && clearInterval(I), I = setInterval((function() {
                                    i.naturalWidth > 0 ? t._onImageHasSize(e) : (n > 200 && clearInterval(I), 3 == ++n ? o(10) : 40 === n ? o(50) : 100 === n && o(500))
                                }), r)
                            };
                        o(1)
                    },
                    getImage: function(n, i) {
                        var o = 0,
                            r = function() {
                                n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, f("ImageLoadComplete")) : ++o < 200 ? setTimeout(r, 100) : a())
                            },
                            a = function() {
            ...
            e.magnificPopup.registerModule("iframe", {
                ...
                proto: {
                    initIframe: function() {
                        t.types.push("iframe"), p("BeforeChange", (function(e, t, n) {
            ...
            e.magnificPopup.registerModule("gallery", {
                ...
                proto: {
                    initGallery: function() {
                        ...
                        a += " mfp-gallery", p("Open" + i, (function() {
                            n.navigateByImgClick && t.wrap.on("click" + i, ".mfp-img", (function() {
                                if (t.items.length > 1) return t.next(), !1
                            })), o.on("keydown" + i, (function(e) {
                                37 === e.keyCode ? t.prev() : 39 === e.keyCode && t.next()
                            }))
                        })), p("UpdateStatus" + i, (function(e, n) {
                            n.text && (n.text = S(n.text, t.currItem.index, t.items.length))
                        })), p("MarkupParse" + i, (function(e, i, o, r) {
                            var a = t.items.length;
                            o.counter = a > 1 ? S(n.tCounter, r.index, a) : ""
                        })), p("BuildControls" + i, (function() {
                    ...
                    _preloadItem: function(n) {
                        if (n = T(n), !t.items[n].preloaded) {
                            var i = t.items[n];
                            i.parsed || (i = t.parseEl(n)), f("LazyLoad", i), "image" === i.type && (i.img = e('<img class="mfp-img" />').on("load.mfploader", (function() {
                                i.hasSize = !0
                ...
                proto: {
                    initRetina: function() {
                        if (window.devicePixelRatio > 1) {
                            var e = t.st.retina,
                                n = e.ratio;
                            (n = isNaN(n) ? n() : n) > 1 && (p("ImageHasSize.retina", (function(e, t) {
                                t.img.css({
